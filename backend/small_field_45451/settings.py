"""
Django settings for small_field_45451 project.
...
ROOT_URLCONF = 'small_field_45451.urls'
...
WSGI_APPLICATION = 'small_field_45451.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_field_45451 API",
    "DESCRIPTION": "API documentation for small_field_45451 App",
    "VERSION": "v1",
}
